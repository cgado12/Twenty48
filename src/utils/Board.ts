    ...
    for (let i = 0; i < 4; i++) {
      for (let j = 0; j < 4; j++) {
        if (this.board[i][j].value) {
          switch (direction) {
            case 'up':
              this.board[i][j].attr = `ver-u-${this.board[i][j].prevRow - this.board[i][j].curRow} overlay`
              break;
            case 'down':
              this.board[i][j].attr = `ver-d-${this.board[i][j].curRow - this.board[i][j].prevRow} overlay`
              break;
            case 'left':
              this.board[i][j].attr = `hor-l-${this.board[i][j].prevCol - this.board[i][j].curCol} overlay`
              break;
            default:
